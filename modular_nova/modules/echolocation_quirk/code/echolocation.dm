...
/datum/quirk/echolocation/add(client/client_source)
	...
	human_holder.AddComponent(/datum/component/echolocation, echo_range = 5, echo_group = client_echo_group, images_are_static = FALSE, blinding = TRUE, use_echo = client_use_echo, show_own_outline = TRUE, cooldown_time = client_echo_speed)
